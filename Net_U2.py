...
from goodthing import ConvolutionLayer, DownSample, upsample_like
...
class U2_net(nn.Module):
    ...
    def forward(self, x):
        ...
        return torch.sigmoid(sup0), torch.sigmoid(sup1), torch.sigmoid(sup2), torch.sigmoid(sup3), torch.sigmoid(
            sup4), torch.sigmoid(sup5), torch.sigmoid(sup6)
